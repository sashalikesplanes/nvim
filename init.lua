...
if vim.g.vscode then
  ...
  -- VSCode refactor actions
  vim.keymap.set({ 'v' }, '<leader>r', [[<Cmd>call VSCodeNotifyVisual('editor.action.refactor', 1)<CR>]])
  ...
  -- VSCode toggle side bar
  vim.keymap.set({ 'n' }, '<leader>b', [[<Cmd>call VSCodeNotify('workbench.action.toggleSidebarVisibility')<CR>]])
  
  -- Jest Test runner
  vim.keymap.set({ 'n' }, '<leader>jr', [[<Cmd>call VSCodeNotify('extension.runJest')<CR>]])
  ...
  if vim.g.started_by_firenvim then
    ...
    vim.o.laststatus = 0
    vim.cmd([[hi Normal guibg=000000 ctermbg=000000]])
  else
    -- Install packer
    ...
    require('packer').startup(function(use)
      ...
      use 'xiyaowong/nvim-transparent' -- Make stuff transparent
      use 'jiangmiao/auto-pairs' -- Auto make closing pairs
      use {
    ...
    vim.keymap.set('n', '<leader>e', require('nvim-tree').toggle, { desc = 'Open [E]xplorer' })
